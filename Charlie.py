https://github.com/Silentboy302/Sd4<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>⫷ 𝙏𝙃𝙀𝙒 —⍟— CHARLIE ⫸</title>
...
<body>
  ...
  <h1 class="mt-3">⫷ ZACHARY—⍟— CH4RLI3 ⫸</h1>
  </header>
  ...
  <footer class="footer">
    <p>© 2024 ᴬˡˡ ᴿⁱᵍʰᵗˢ ᴿᵉᶜᵉⁱᵛᵉᵈ ᴮʸ ᵀʰᵉ'ʷ ᴹ⁰ᶻᶻ  <a href="https://www.facebook.com/thew.m0zZW">ᴄʟɪᴄᴋ ʜᴇʀᴇ ғᴏʀ ғᴀᴄᴀʙᴏᴏᴋ</a></p>
    <div class="mb-3">
      <a href="https://wa.me/+923168562849" class="whatsapp-link">
